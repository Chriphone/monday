...
urlpatterns = [
    ...
    path('studentclick', views.studentclick_view, name="studentclick_view"),
     path('student_signup_view',views.student_signup_view,name="student_signup_view"),
     path('teacher_signup_view',views.teacher_signup_view,name="teacher_signup_view"),
     path('studentlogin', LoginView.as_view(template_name='kmet/studentlogin.html')),
    path('teacherlogin', LoginView.as_view(template_name='kmet/teacherlogin.html')),
    ...
    path('marks',views.marks,name='marks'),
      path('addmark/<int:pk>', views.addmark,name='marks'),

    #path('addmarks/<int:pk>', views.addmarks,name='addmarks'),
    ...
    path('adminlogin', LoginView.as_view(template_name='kmet/adminlogin.html')),
    path('studentlogin', LoginView.as_view(template_name='kmet/studentlogin.html')),
    path('teacherlogin', LoginView.as_view(template_name='kmet/teacherlogin.html')),


    path('afterlogin', views.afterlogin_view,name='afterlogin'),
    path('logout', LogoutView.as_view(template_name='kmet/index.html'),name='logout'),
    ...
    path('update-student-marks/<int:pk>', views.update_student_view_marks,name='update-student-marks'),
